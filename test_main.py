...
test_directory = "/Users/stan/Documents/uni/year_3/rp/seq2point-nilm-master/data/pecanstreet/15minute/final/house-558/house-558_test_.csv"

parser = argparse.ArgumentParser(description="Train a pruned neural network for energy disaggregation.")

parser.add_argument("--appliance_name", type=remove_space, default="kettle", help="The name of the appliance to "
                                                                                  "perform disaggregation with. "
                                                                                  "Default is kettle. Available are: "
                                                                                  "kettle, fridge, dishwasher, "
                                                                                  "microwave.")
...
parser.add_argument("--algorithm", type=remove_space, default="seq2point", help="The pruning algorithm of the model "
                                                                                "to test. Default is none.")
parser.add_argument("--network_type", type=remove_space, default="", help="The seq2point architecture to use. Only "
                                                                          "use if you do not want to use the standard "
                                                                          "architecture. Available are: default, "
                                                                          "dropout, reduced, and reduced_dropout.")
