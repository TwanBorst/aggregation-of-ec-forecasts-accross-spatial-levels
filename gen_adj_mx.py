...
if __name__ == '__main__':
    ...
    parser.add_argument('--normalized_k', type=float, default=0.00001,
    ...
    print(distance_df.columns[0])
    distance_df = distance_df.drop('Unnamed: 0', axis=1)
...
# --sensor_ids_filename=data/graph/ids_al100.txt --distances_filename=data/graph/distances_al100.csv --output_pkl_filename=data/graph/adj_mat_al100.pkl