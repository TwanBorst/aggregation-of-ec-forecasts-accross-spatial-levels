...
# training_directory = "/Users/stan/Documents/uni/year_3/rp/seq2point-nilm-master/kettle/kettle_training_.csv"
# validation_directory = "/Users/stan/Documents/uni/year_3/rp/seq2point-nilm-master/kettle/kettle_validation_.csv"

training_directory = "/Users/stan/Documents/uni/year_3/rp/seq2point-nilm-master/data/pecanstreet/15minute/final/house-558/house-558_training_.csv"
validation_directory = "/Users/stan/Documents/uni/year_3/rp/seq2point-nilm-master/data/pecanstreet/15minute/final/house-558/house-558_validation_.csv"

parser = argparse.ArgumentParser(description="Train sequence-to-point learning for energy disaggregation. ")

parser.add_argument("--appliance_name", type=remove_space, default="kettle", help="The name of the appliance to train "
                                                                                  "the network with. Default is "
                                                                                  "kettle. Available are: kettle, "
                                                                                  "fridge, washing machine, "
                                                                                  "dishwasher, and microwave.")
parser.add_argument("--batch_size", type=int, default="1000", help="The batch size to use when training the network. "
                                                                   "Default is 1000.")
parser.add_argument("--crop", type=int, default="100000", help="The number of rows of the dataset to take training "
                                                              "data from. Default is 10000.")
# parser.add_argument("--pruning_algorithm", type=remove_space, default="default", help="The pruning algorithm that the "
#                                                                                       "network will train with. "
#                                                                                       "Default is none. Available "
#                                                                                       "are: spp, entropic, threshold.")
...
parser.add_argument("--validation_directory", type=str, default=validation_directory, help="The dir for validation "
                                                                                           "data.")
