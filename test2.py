...
parser.add_argument('--best_id', type=int)
parser.add_argument('--best_loss', type=float)
...
def main():
    ...
    engine.model.load_state_dict(
        torch.load(args.save + '_exp1_best_' + str(args.best_loss) + "_epoch_" + str(bestid) + ".pth"))
    ...
    # df2.to_csv(args.save_path + '.csv', index=False)
